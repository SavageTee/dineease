...
import { logErrorAndRespond, validateContentType, validateRequestBodyKeys, validateRequestBody, LimitFileSize } from "../../../helpers/admin_herlpers"
...
adminHotelsApi.use((err:any, req:Request, res:Response, next:NextFunction) => LimitFileSize(err, req, res, next, 'logo'));
